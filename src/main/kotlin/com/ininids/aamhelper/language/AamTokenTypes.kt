...
object AamTokenTypes {
    ...
    val DERIVE_SCHEMA = AamTokenType("DERIVE_SCHEMA")
    val SCHEMA_NAME = AamTokenType("SCHEMA_NAME")
    val LBRACE = AamTokenType("LBRACE")
    val RBRACE = AamTokenType("RBRACE")
    val LBRACKET = AamTokenType("LBRACKET")
    val RBRACKET = AamTokenType("RBRACKET")
    val FIELD_NAME = AamTokenType("FIELD_NAME")
    val FIELD_TYPE = AamTokenType("FIELD_TYPE")
    val OPTIONAL_MARKER = AamTokenType("OPTIONAL_MARKER")
    val LIST_KEYWORD = AamTokenType("LIST_KEYWORD")
    val LANGLE = AamTokenType("LANGLE")
    val RANGLE = AamTokenType("RANGLE")
